...
var Test = (function () {
    function Test() {
        ...
        this.authorization = "";
        this.samplesLocal = "";
        this.samplesWeb = "https://wabr.inliteresearch.com/SampleImages/";
        this.bTestDropBox = true;
        this.bTestSamplesLocal = true;
        this.bTestSamplesWeb = true;
        this.bTestBase64 = true;
        this.bTestUtf8 = true;
        this.bTestUtf8Names = true;
    }
    Test.prototype.Run = function (reader) {
    ...
    Test.ShowBarcodes = function (barcodes) {
    ...
    Test.prototype.Read = function (reader, image, types, dir, tbr) {
        var callback = this.ReaderCallback;
        reader.ReadAsync(image, callback, image, types, dir, tbr);
    };
    Test.prototype.ReaderCallback = function (evnt, value, obj) {
        if (evnt == "error") {
    ...
    Test.bShowDiag = false;
    Test.bShowBarcodes = true;
    return Test;
})();
exports.Test = Test;
